...
export class RoomAmenitiy {
    ...
    * Room amenity type
    */
    'roomAmenityType': RoomAmenitiy.RoomAmenityTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "isComplimentary",
            "type": "boolean"
        },
        {
            "name": "roomAmenityType",
            "baseName": "roomAmenityType",
            "type": "RoomAmenitiy.RoomAmenityTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return RoomAmenitiy.attributeTypeMap;
    }
}

export namespace RoomAmenitiy {
    export enum RoomAmenityTypeEnum {
        Unknown = <any> 'UNKNOWN',
