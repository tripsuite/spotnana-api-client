...
/**
* Wrapper for VendorProgramPaymentDescriptor
*/
export class VendorProgramPaymentDescriptorWrapper {
    ...
    static getAttributeTypeMap() {
        return VendorProgramPaymentDescriptorWrapper.attributeTypeMap;
    }
}
